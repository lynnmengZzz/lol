...
<head>
    ...
    <link rel="stylesheet" href="{{asset('home/css/jquery.vidbacking.css')}}">
</head>

<body class="skin-orange">
<header class="primary">

    <div class="firstbar" style="background: url('{{asset('home/images/timg(1).jpg')}}')">
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-12">
                    <div class="brand">
                        <a href="{{url('/')}}">
                            <img src="{{asset('home/images/qiuzhendui.jpg')}}" alt="WEB LOGO">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-12 text-right">
                    ...
                    <ul class="nav-icons">
                        ...
                        <li><a href="#"><i class="ion-coffee"></i>
        ...
        <div class="container">
            ...
            <div id="menu-list">
                <ul class="nav-list">
                    ...
                    <li class="dropdown magz-dropdown"><a href="#">Dropdown </a>
                        <ul class="dropdown-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="{{ route('logout') }}"
                                ...
                                <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                                    {{ csrf_field() }}
                                </form><i class="icon ion-log-out"></i> Logout</li>
                        </ul>
                    </li>
                </ul>
            </div>
...
<script src="{{asset('home/js/jquery.vidbacking.js')}}"></script>
</body>
